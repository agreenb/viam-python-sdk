...
_GETTRAININGJOBREQUEST = DESCRIPTOR.message_types_by_name['GetTrainingJobRequest']
_GETTRAININGJOBRESPONSE = DESCRIPTOR.message_types_by_name['GetTrainingJobResponse']
_LISTTRAININGJOBSREQUEST = DESCRIPTOR.message_types_by_name['ListTrainingJobsRequest']
_LISTTRAININGJOBSRESPONSE = DESCRIPTOR.message_types_by_name['ListTrainingJobsResponse']
_TRAININGJOBMETADATA = DESCRIPTOR.message_types_by_name['TrainingJobMetadata']
...
SubmitTrainingJobRequest = _reflection.GeneratedProtocolMessageType('SubmitTrainingJobRequest', (_message.Message,), {'DESCRIPTOR': _SUBMITTRAININGJOBREQUEST, '__module__': 'app.mltraining.v1.ml_training_pb2'})
_sym_db.RegisterMessage(SubmitTrainingJobRequest)
SubmitTrainingJobResponse = _reflection.GeneratedProtocolMessageType('SubmitTrainingJobResponse', (_message.Message,), {'DESCRIPTOR': _SUBMITTRAININGJOBRESPONSE, '__module__': 'app.mltraining.v1.ml_training_pb2'})
_sym_db.RegisterMessage(SubmitTrainingJobResponse)
GetTrainingJobRequest = _reflection.GeneratedProtocolMessageType('GetTrainingJobRequest', (_message.Message,), {'DESCRIPTOR': _GETTRAININGJOBREQUEST, '__module__': 'app.mltraining.v1.ml_training_pb2'})
_sym_db.RegisterMessage(GetTrainingJobRequest)
GetTrainingJobResponse = _reflection.GeneratedProtocolMessageType('GetTrainingJobResponse', (_message.Message,), {'DESCRIPTOR': _GETTRAININGJOBRESPONSE, '__module__': 'app.mltraining.v1.ml_training_pb2'})
_sym_db.RegisterMessage(GetTrainingJobResponse)
ListTrainingJobsRequest = _reflection.GeneratedProtocolMessageType('ListTrainingJobsRequest', (_message.Message,), {'DESCRIPTOR': _LISTTRAININGJOBSREQUEST, '__module__': 'app.mltraining.v1.ml_training_pb2'})
_sym_db.RegisterMessage(ListTrainingJobsRequest)
ListTrainingJobsResponse = _reflection.GeneratedProtocolMessageType('ListTrainingJobsResponse', (_message.Message,), {'DESCRIPTOR': _LISTTRAININGJOBSRESPONSE, '__module__': 'app.mltraining.v1.ml_training_pb2'})
_sym_db.RegisterMessage(ListTrainingJobsResponse)
TrainingJobMetadata = _reflection.GeneratedProtocolMessageType('TrainingJobMetadata', (_message.Message,), {'DESCRIPTOR': _TRAININGJOBMETADATA, '__module__': 'app.mltraining.v1.ml_training_pb2'})
_sym_db.RegisterMessage(TrainingJobMetadata)
CancelTrainingJobRequest = _reflection.GeneratedProtocolMessageType('CancelTrainingJobRequest', (_message.Message,), {'DESCRIPTOR': _CANCELTRAININGJOBREQUEST, '__module__': 'app.mltraining.v1.ml_training_pb2'})
_sym_db.RegisterMessage(CancelTrainingJobRequest)
CancelTrainingJobResponse = _reflection.GeneratedProtocolMessageType('CancelTrainingJobResponse', (_message.Message,), {'DESCRIPTOR': _CANCELTRAININGJOBRESPONSE, '__module__': 'app.mltraining.v1.ml_training_pb2'})
_sym_db.RegisterMessage(CancelTrainingJobResponse)
_MLTRAININGSERVICE = DESCRIPTOR.services_by_name['MLTrainingService']
