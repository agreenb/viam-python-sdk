...
_GETREADINGSRESPONSE_READINGSENTRY = _GETREADINGSRESPONSE.nested_types_by_name['ReadingsEntry']
GetReadingsRequest = _reflection.GeneratedProtocolMessageType('GetReadingsRequest', (_message.Message,), {'DESCRIPTOR': _GETREADINGSREQUEST, '__module__': 'component.sensor.v1.sensor_pb2'})
_sym_db.RegisterMessage(GetReadingsRequest)
GetReadingsResponse = _reflection.GeneratedProtocolMessageType('GetReadingsResponse', (_message.Message,), {'ReadingsEntry': _reflection.GeneratedProtocolMessageType('ReadingsEntry', (_message.Message,), {'DESCRIPTOR': _GETREADINGSRESPONSE_READINGSENTRY, '__module__': 'component.sensor.v1.sensor_pb2'}), 'DESCRIPTOR': _GETREADINGSRESPONSE, '__module__': 'component.sensor.v1.sensor_pb2'})
_sym_db.RegisterMessage(GetReadingsResponse)
_sym_db.RegisterMessage(GetReadingsResponse.ReadingsEntry)
