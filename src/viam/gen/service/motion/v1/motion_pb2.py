...
_MOVEONMAPREQUEST = DESCRIPTOR.message_types_by_name['MoveOnMapRequest']
_MOVEONMAPRESPONSE = DESCRIPTOR.message_types_by_name['MoveOnMapResponse']
_MOTIONCONFIGURATION = DESCRIPTOR.message_types_by_name['MotionConfiguration']
_MOVEONGLOBEREQUEST = DESCRIPTOR.message_types_by_name['MoveOnGlobeRequest']
_MOVEONGLOBERESPONSE = DESCRIPTOR.message_types_by_name['MoveOnGlobeResponse']
...
_LINEARCONSTRAINT = DESCRIPTOR.message_types_by_name['LinearConstraint']
_ORIENTATIONCONSTRAINT = DESCRIPTOR.message_types_by_name['OrientationConstraint']
_COLLISIONSPECIFICATION = DESCRIPTOR.message_types_by_name['CollisionSpecification']
_COLLISIONSPECIFICATION_ALLOWEDFRAMECOLLISIONS = _COLLISIONSPECIFICATION.nested_types_by_name['AllowedFrameCollisions']
MoveRequest = _reflection.GeneratedProtocolMessageType('MoveRequest', (_message.Message,), {'DESCRIPTOR': _MOVEREQUEST, '__module__': 'service.motion.v1.motion_pb2'})
_sym_db.RegisterMessage(MoveRequest)
MoveResponse = _reflection.GeneratedProtocolMessageType('MoveResponse', (_message.Message,), {'DESCRIPTOR': _MOVERESPONSE, '__module__': 'service.motion.v1.motion_pb2'})
_sym_db.RegisterMessage(MoveResponse)
MoveOnMapRequest = _reflection.GeneratedProtocolMessageType('MoveOnMapRequest', (_message.Message,), {'DESCRIPTOR': _MOVEONMAPREQUEST, '__module__': 'service.motion.v1.motion_pb2'})
_sym_db.RegisterMessage(MoveOnMapRequest)
MoveOnMapResponse = _reflection.GeneratedProtocolMessageType('MoveOnMapResponse', (_message.Message,), {'DESCRIPTOR': _MOVEONMAPRESPONSE, '__module__': 'service.motion.v1.motion_pb2'})
_sym_db.RegisterMessage(MoveOnMapResponse)
MotionConfiguration = _reflection.GeneratedProtocolMessageType('MotionConfiguration', (_message.Message,), {'DESCRIPTOR': _MOTIONCONFIGURATION, '__module__': 'service.motion.v1.motion_pb2'})
_sym_db.RegisterMessage(MotionConfiguration)
MoveOnGlobeRequest = _reflection.GeneratedProtocolMessageType('MoveOnGlobeRequest', (_message.Message,), {'DESCRIPTOR': _MOVEONGLOBEREQUEST, '__module__': 'service.motion.v1.motion_pb2'})
_sym_db.RegisterMessage(MoveOnGlobeRequest)
MoveOnGlobeResponse = _reflection.GeneratedProtocolMessageType('MoveOnGlobeResponse', (_message.Message,), {'DESCRIPTOR': _MOVEONGLOBERESPONSE, '__module__': 'service.motion.v1.motion_pb2'})
_sym_db.RegisterMessage(MoveOnGlobeResponse)
GetPoseRequest = _reflection.GeneratedProtocolMessageType('GetPoseRequest', (_message.Message,), {'DESCRIPTOR': _GETPOSEREQUEST, '__module__': 'service.motion.v1.motion_pb2'})
_sym_db.RegisterMessage(GetPoseRequest)
GetPoseResponse = _reflection.GeneratedProtocolMessageType('GetPoseResponse', (_message.Message,), {'DESCRIPTOR': _GETPOSERESPONSE, '__module__': 'service.motion.v1.motion_pb2'})
_sym_db.RegisterMessage(GetPoseResponse)
Constraints = _reflection.GeneratedProtocolMessageType('Constraints', (_message.Message,), {'DESCRIPTOR': _CONSTRAINTS, '__module__': 'service.motion.v1.motion_pb2'})
_sym_db.RegisterMessage(Constraints)
LinearConstraint = _reflection.GeneratedProtocolMessageType('LinearConstraint', (_message.Message,), {'DESCRIPTOR': _LINEARCONSTRAINT, '__module__': 'service.motion.v1.motion_pb2'})
_sym_db.RegisterMessage(LinearConstraint)
OrientationConstraint = _reflection.GeneratedProtocolMessageType('OrientationConstraint', (_message.Message,), {'DESCRIPTOR': _ORIENTATIONCONSTRAINT, '__module__': 'service.motion.v1.motion_pb2'})
_sym_db.RegisterMessage(OrientationConstraint)
CollisionSpecification = _reflection.GeneratedProtocolMessageType('CollisionSpecification', (_message.Message,), {'AllowedFrameCollisions': _reflection.GeneratedProtocolMessageType('AllowedFrameCollisions', (_message.Message,), {'DESCRIPTOR': _COLLISIONSPECIFICATION_ALLOWEDFRAMECOLLISIONS, '__module__': 'service.motion.v1.motion_pb2'}), 'DESCRIPTOR': _COLLISIONSPECIFICATION, '__module__': 'service.motion.v1.motion_pb2'})
_sym_db.RegisterMessage(CollisionSpecification)
_sym_db.RegisterMessage(CollisionSpecification.AllowedFrameCollisions)
