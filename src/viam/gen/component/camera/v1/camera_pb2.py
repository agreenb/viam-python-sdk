...
_GETIMAGESREQUEST = DESCRIPTOR.message_types_by_name['GetImagesRequest']
_GETIMAGESRESPONSE = DESCRIPTOR.message_types_by_name['GetImagesResponse']
...
_INTRINSICPARAMETERS = DESCRIPTOR.message_types_by_name['IntrinsicParameters']
_DISTORTIONPARAMETERS = DESCRIPTOR.message_types_by_name['DistortionParameters']
GetImageRequest = _reflection.GeneratedProtocolMessageType('GetImageRequest', (_message.Message,), {'DESCRIPTOR': _GETIMAGEREQUEST, '__module__': 'component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(GetImageRequest)
GetImageResponse = _reflection.GeneratedProtocolMessageType('GetImageResponse', (_message.Message,), {'DESCRIPTOR': _GETIMAGERESPONSE, '__module__': 'component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(GetImageResponse)
GetImagesRequest = _reflection.GeneratedProtocolMessageType('GetImagesRequest', (_message.Message,), {'DESCRIPTOR': _GETIMAGESREQUEST, '__module__': 'component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(GetImagesRequest)
GetImagesResponse = _reflection.GeneratedProtocolMessageType('GetImagesResponse', (_message.Message,), {'DESCRIPTOR': _GETIMAGESRESPONSE, '__module__': 'component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(GetImagesResponse)
Image = _reflection.GeneratedProtocolMessageType('Image', (_message.Message,), {'DESCRIPTOR': _IMAGE, '__module__': 'component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(Image)
RenderFrameRequest = _reflection.GeneratedProtocolMessageType('RenderFrameRequest', (_message.Message,), {'DESCRIPTOR': _RENDERFRAMEREQUEST, '__module__': 'component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(RenderFrameRequest)
GetPointCloudRequest = _reflection.GeneratedProtocolMessageType('GetPointCloudRequest', (_message.Message,), {'DESCRIPTOR': _GETPOINTCLOUDREQUEST, '__module__': 'component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(GetPointCloudRequest)
GetPointCloudResponse = _reflection.GeneratedProtocolMessageType('GetPointCloudResponse', (_message.Message,), {'DESCRIPTOR': _GETPOINTCLOUDRESPONSE, '__module__': 'component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(GetPointCloudResponse)
GetPropertiesRequest = _reflection.GeneratedProtocolMessageType('GetPropertiesRequest', (_message.Message,), {'DESCRIPTOR': _GETPROPERTIESREQUEST, '__module__': 'component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(GetPropertiesRequest)
GetPropertiesResponse = _reflection.GeneratedProtocolMessageType('GetPropertiesResponse', (_message.Message,), {'DESCRIPTOR': _GETPROPERTIESRESPONSE, '__module__': 'component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(GetPropertiesResponse)
Webcams = _reflection.GeneratedProtocolMessageType('Webcams', (_message.Message,), {'DESCRIPTOR': _WEBCAMS, '__module__': 'component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(Webcams)
Webcam = _reflection.GeneratedProtocolMessageType('Webcam', (_message.Message,), {'DESCRIPTOR': _WEBCAM, '__module__': 'component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(Webcam)
Property = _reflection.GeneratedProtocolMessageType('Property', (_message.Message,), {'DESCRIPTOR': _PROPERTY, '__module__': 'component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(Property)
IntrinsicParameters = _reflection.GeneratedProtocolMessageType('IntrinsicParameters', (_message.Message,), {'DESCRIPTOR': _INTRINSICPARAMETERS, '__module__': 'component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(IntrinsicParameters)
DistortionParameters = _reflection.GeneratedProtocolMessageType('DistortionParameters', (_message.Message,), {'DESCRIPTOR': _DISTORTIONPARAMETERS, '__module__': 'component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(DistortionParameters)
