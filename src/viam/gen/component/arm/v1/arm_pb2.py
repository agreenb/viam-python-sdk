...
GetEndPositionRequest = _reflection.GeneratedProtocolMessageType('GetEndPositionRequest', (_message.Message,), {'DESCRIPTOR': _GETENDPOSITIONREQUEST, '__module__': 'component.arm.v1.arm_pb2'})
_sym_db.RegisterMessage(GetEndPositionRequest)
GetEndPositionResponse = _reflection.GeneratedProtocolMessageType('GetEndPositionResponse', (_message.Message,), {'DESCRIPTOR': _GETENDPOSITIONRESPONSE, '__module__': 'component.arm.v1.arm_pb2'})
_sym_db.RegisterMessage(GetEndPositionResponse)
JointPositions = _reflection.GeneratedProtocolMessageType('JointPositions', (_message.Message,), {'DESCRIPTOR': _JOINTPOSITIONS, '__module__': 'component.arm.v1.arm_pb2'})
_sym_db.RegisterMessage(JointPositions)
GetJointPositionsRequest = _reflection.GeneratedProtocolMessageType('GetJointPositionsRequest', (_message.Message,), {'DESCRIPTOR': _GETJOINTPOSITIONSREQUEST, '__module__': 'component.arm.v1.arm_pb2'})
_sym_db.RegisterMessage(GetJointPositionsRequest)
GetJointPositionsResponse = _reflection.GeneratedProtocolMessageType('GetJointPositionsResponse', (_message.Message,), {'DESCRIPTOR': _GETJOINTPOSITIONSRESPONSE, '__module__': 'component.arm.v1.arm_pb2'})
_sym_db.RegisterMessage(GetJointPositionsResponse)
MoveToPositionRequest = _reflection.GeneratedProtocolMessageType('MoveToPositionRequest', (_message.Message,), {'DESCRIPTOR': _MOVETOPOSITIONREQUEST, '__module__': 'component.arm.v1.arm_pb2'})
_sym_db.RegisterMessage(MoveToPositionRequest)
MoveToPositionResponse = _reflection.GeneratedProtocolMessageType('MoveToPositionResponse', (_message.Message,), {'DESCRIPTOR': _MOVETOPOSITIONRESPONSE, '__module__': 'component.arm.v1.arm_pb2'})
_sym_db.RegisterMessage(MoveToPositionResponse)
MoveToJointPositionsRequest = _reflection.GeneratedProtocolMessageType('MoveToJointPositionsRequest', (_message.Message,), {'DESCRIPTOR': _MOVETOJOINTPOSITIONSREQUEST, '__module__': 'component.arm.v1.arm_pb2'})
_sym_db.RegisterMessage(MoveToJointPositionsRequest)
MoveToJointPositionsResponse = _reflection.GeneratedProtocolMessageType('MoveToJointPositionsResponse', (_message.Message,), {'DESCRIPTOR': _MOVETOJOINTPOSITIONSRESPONSE, '__module__': 'component.arm.v1.arm_pb2'})
_sym_db.RegisterMessage(MoveToJointPositionsResponse)
StopRequest = _reflection.GeneratedProtocolMessageType('StopRequest', (_message.Message,), {'DESCRIPTOR': _STOPREQUEST, '__module__': 'component.arm.v1.arm_pb2'})
_sym_db.RegisterMessage(StopRequest)
StopResponse = _reflection.GeneratedProtocolMessageType('StopResponse', (_message.Message,), {'DESCRIPTOR': _STOPRESPONSE, '__module__': 'component.arm.v1.arm_pb2'})
_sym_db.RegisterMessage(StopResponse)
Status = _reflection.GeneratedProtocolMessageType('Status', (_message.Message,), {'DESCRIPTOR': _STATUS, '__module__': 'component.arm.v1.arm_pb2'})
_sym_db.RegisterMessage(Status)
IsMovingRequest = _reflection.GeneratedProtocolMessageType('IsMovingRequest', (_message.Message,), {'DESCRIPTOR': _ISMOVINGREQUEST, '__module__': 'component.arm.v1.arm_pb2'})
_sym_db.RegisterMessage(IsMovingRequest)
IsMovingResponse = _reflection.GeneratedProtocolMessageType('IsMovingResponse', (_message.Message,), {'DESCRIPTOR': _ISMOVINGRESPONSE, '__module__': 'component.arm.v1.arm_pb2'})
