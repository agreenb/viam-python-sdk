...
_SHELLREQUEST = DESCRIPTOR.message_types_by_name['ShellRequest']
_SHELLRESPONSE = DESCRIPTOR.message_types_by_name['ShellResponse']
ShellRequest = _reflection.GeneratedProtocolMessageType('ShellRequest', (_message.Message,), {'DESCRIPTOR': _SHELLREQUEST, '__module__': 'service.shell.v1.shell_pb2'})
_sym_db.RegisterMessage(ShellRequest)
ShellResponse = _reflection.GeneratedProtocolMessageType('ShellResponse', (_message.Message,), {'DESCRIPTOR': _SHELLRESPONSE, '__module__': 'service.shell.v1.shell_pb2'})
_sym_db.RegisterMessage(ShellResponse)
