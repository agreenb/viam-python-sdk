...
_SAMPLEFORMAT = DESCRIPTOR.enum_types_by_name['SampleFormat']
SampleFormat = enum_type_wrapper.EnumTypeWrapper(_SAMPLEFORMAT)
...
_AUDIOCHUNKINFO = DESCRIPTOR.message_types_by_name['AudioChunkInfo']
_AUDIOCHUNK = DESCRIPTOR.message_types_by_name['AudioChunk']
_CHUNKSREQUEST = DESCRIPTOR.message_types_by_name['ChunksRequest']
_CHUNKSRESPONSE = DESCRIPTOR.message_types_by_name['ChunksResponse']
_PROPERTIESREQUEST = DESCRIPTOR.message_types_by_name['PropertiesRequest']
_PROPERTIESRESPONSE = DESCRIPTOR.message_types_by_name['PropertiesResponse']
RecordRequest = _reflection.GeneratedProtocolMessageType('RecordRequest', (_message.Message,), {'DESCRIPTOR': _RECORDREQUEST, '__module__': 'component.audioinput.v1.audioinput_pb2'})
_sym_db.RegisterMessage(RecordRequest)
AudioChunkInfo = _reflection.GeneratedProtocolMessageType('AudioChunkInfo', (_message.Message,), {'DESCRIPTOR': _AUDIOCHUNKINFO, '__module__': 'component.audioinput.v1.audioinput_pb2'})
_sym_db.RegisterMessage(AudioChunkInfo)
AudioChunk = _reflection.GeneratedProtocolMessageType('AudioChunk', (_message.Message,), {'DESCRIPTOR': _AUDIOCHUNK, '__module__': 'component.audioinput.v1.audioinput_pb2'})
_sym_db.RegisterMessage(AudioChunk)
ChunksRequest = _reflection.GeneratedProtocolMessageType('ChunksRequest', (_message.Message,), {'DESCRIPTOR': _CHUNKSREQUEST, '__module__': 'component.audioinput.v1.audioinput_pb2'})
_sym_db.RegisterMessage(ChunksRequest)
ChunksResponse = _reflection.GeneratedProtocolMessageType('ChunksResponse', (_message.Message,), {'DESCRIPTOR': _CHUNKSRESPONSE, '__module__': 'component.audioinput.v1.audioinput_pb2'})
_sym_db.RegisterMessage(ChunksResponse)
PropertiesRequest = _reflection.GeneratedProtocolMessageType('PropertiesRequest', (_message.Message,), {'DESCRIPTOR': _PROPERTIESREQUEST, '__module__': 'component.audioinput.v1.audioinput_pb2'})
_sym_db.RegisterMessage(PropertiesRequest)
PropertiesResponse = _reflection.GeneratedProtocolMessageType('PropertiesResponse', (_message.Message,), {'DESCRIPTOR': _PROPERTIESRESPONSE, '__module__': 'component.audioinput.v1.audioinput_pb2'})
_sym_db.RegisterMessage(PropertiesResponse)
_AUDIOINPUTSERVICE = DESCRIPTOR.services_by_name['AudioInputService']
