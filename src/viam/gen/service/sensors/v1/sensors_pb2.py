...
_READINGS_READINGSENTRY = _READINGS.nested_types_by_name['ReadingsEntry']
_GETREADINGSRESPONSE = DESCRIPTOR.message_types_by_name['GetReadingsResponse']
GetSensorsRequest = _reflection.GeneratedProtocolMessageType('GetSensorsRequest', (_message.Message,), {'DESCRIPTOR': _GETSENSORSREQUEST, '__module__': 'service.sensors.v1.sensors_pb2'})
_sym_db.RegisterMessage(GetSensorsRequest)
GetSensorsResponse = _reflection.GeneratedProtocolMessageType('GetSensorsResponse', (_message.Message,), {'DESCRIPTOR': _GETSENSORSRESPONSE, '__module__': 'service.sensors.v1.sensors_pb2'})
_sym_db.RegisterMessage(GetSensorsResponse)
GetReadingsRequest = _reflection.GeneratedProtocolMessageType('GetReadingsRequest', (_message.Message,), {'DESCRIPTOR': _GETREADINGSREQUEST, '__module__': 'service.sensors.v1.sensors_pb2'})
_sym_db.RegisterMessage(GetReadingsRequest)
Readings = _reflection.GeneratedProtocolMessageType('Readings', (_message.Message,), {'ReadingsEntry': _reflection.GeneratedProtocolMessageType('ReadingsEntry', (_message.Message,), {'DESCRIPTOR': _READINGS_READINGSENTRY, '__module__': 'service.sensors.v1.sensors_pb2'}), 'DESCRIPTOR': _READINGS, '__module__': 'service.sensors.v1.sensors_pb2'})
_sym_db.RegisterMessage(Readings)
_sym_db.RegisterMessage(Readings.ReadingsEntry)
GetReadingsResponse = _reflection.GeneratedProtocolMessageType('GetReadingsResponse', (_message.Message,), {'DESCRIPTOR': _GETREADINGSRESPONSE, '__module__': 'service.sensors.v1.sensors_pb2'})
