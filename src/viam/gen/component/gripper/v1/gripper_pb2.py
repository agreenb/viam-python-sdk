...
OpenRequest = _reflection.GeneratedProtocolMessageType('OpenRequest', (_message.Message,), {'DESCRIPTOR': _OPENREQUEST, '__module__': 'component.gripper.v1.gripper_pb2'})
_sym_db.RegisterMessage(OpenRequest)
OpenResponse = _reflection.GeneratedProtocolMessageType('OpenResponse', (_message.Message,), {'DESCRIPTOR': _OPENRESPONSE, '__module__': 'component.gripper.v1.gripper_pb2'})
_sym_db.RegisterMessage(OpenResponse)
GrabRequest = _reflection.GeneratedProtocolMessageType('GrabRequest', (_message.Message,), {'DESCRIPTOR': _GRABREQUEST, '__module__': 'component.gripper.v1.gripper_pb2'})
_sym_db.RegisterMessage(GrabRequest)
GrabResponse = _reflection.GeneratedProtocolMessageType('GrabResponse', (_message.Message,), {'DESCRIPTOR': _GRABRESPONSE, '__module__': 'component.gripper.v1.gripper_pb2'})
_sym_db.RegisterMessage(GrabResponse)
StopRequest = _reflection.GeneratedProtocolMessageType('StopRequest', (_message.Message,), {'DESCRIPTOR': _STOPREQUEST, '__module__': 'component.gripper.v1.gripper_pb2'})
_sym_db.RegisterMessage(StopRequest)
StopResponse = _reflection.GeneratedProtocolMessageType('StopResponse', (_message.Message,), {'DESCRIPTOR': _STOPRESPONSE, '__module__': 'component.gripper.v1.gripper_pb2'})
_sym_db.RegisterMessage(StopResponse)
IsMovingRequest = _reflection.GeneratedProtocolMessageType('IsMovingRequest', (_message.Message,), {'DESCRIPTOR': _ISMOVINGREQUEST, '__module__': 'component.gripper.v1.gripper_pb2'})
_sym_db.RegisterMessage(IsMovingRequest)
IsMovingResponse = _reflection.GeneratedProtocolMessageType('IsMovingResponse', (_message.Message,), {'DESCRIPTOR': _ISMOVINGRESPONSE, '__module__': 'component.gripper.v1.gripper_pb2'})
