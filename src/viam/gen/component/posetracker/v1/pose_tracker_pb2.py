...
GetPosesRequest = _reflection.GeneratedProtocolMessageType('GetPosesRequest', (_message.Message,), {'DESCRIPTOR': _GETPOSESREQUEST, '__module__': 'component.posetracker.v1.pose_tracker_pb2'})
_sym_db.RegisterMessage(GetPosesRequest)
GetPosesResponse = _reflection.GeneratedProtocolMessageType('GetPosesResponse', (_message.Message,), {'BodyPosesEntry': _reflection.GeneratedProtocolMessageType('BodyPosesEntry', (_message.Message,), {'DESCRIPTOR': _GETPOSESRESPONSE_BODYPOSESENTRY, '__module__': 'component.posetracker.v1.pose_tracker_pb2'}), 'DESCRIPTOR': _GETPOSESRESPONSE, '__module__': 'component.posetracker.v1.pose_tracker_pb2'})
