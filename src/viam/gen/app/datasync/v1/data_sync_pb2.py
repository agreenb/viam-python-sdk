...
DATA_TYPE_FILE = 3
_DATACAPTUREUPLOADREQUEST = DESCRIPTOR.message_types_by_name['DataCaptureUploadRequest']
_DATACAPTUREUPLOADRESPONSE = DESCRIPTOR.message_types_by_name['DataCaptureUploadResponse']
...
_STREAMINGDATACAPTUREUPLOADREQUEST = DESCRIPTOR.message_types_by_name['StreamingDataCaptureUploadRequest']
_STREAMINGDATACAPTUREUPLOADRESPONSE = DESCRIPTOR.message_types_by_name['StreamingDataCaptureUploadResponse']
...
_UPLOADMETADATA_METHODPARAMETERSENTRY = _UPLOADMETADATA.nested_types_by_name['MethodParametersEntry']
_CAPTUREINTERVAL = DESCRIPTOR.message_types_by_name['CaptureInterval']
_DATACAPTUREMETADATA = DESCRIPTOR.message_types_by_name['DataCaptureMetadata']
_DATACAPTUREMETADATA_METHODPARAMETERSENTRY = _DATACAPTUREMETADATA.nested_types_by_name['MethodParametersEntry']
_DATACAPTUREUPLOADMETADATA = DESCRIPTOR.message_types_by_name['DataCaptureUploadMetadata']
DataCaptureUploadRequest = _reflection.GeneratedProtocolMessageType('DataCaptureUploadRequest', (_message.Message,), {'DESCRIPTOR': _DATACAPTUREUPLOADREQUEST, '__module__': 'app.datasync.v1.data_sync_pb2'})
_sym_db.RegisterMessage(DataCaptureUploadRequest)
DataCaptureUploadResponse = _reflection.GeneratedProtocolMessageType('DataCaptureUploadResponse', (_message.Message,), {'DESCRIPTOR': _DATACAPTUREUPLOADRESPONSE, '__module__': 'app.datasync.v1.data_sync_pb2'})
_sym_db.RegisterMessage(DataCaptureUploadResponse)
FileUploadRequest = _reflection.GeneratedProtocolMessageType('FileUploadRequest', (_message.Message,), {'DESCRIPTOR': _FILEUPLOADREQUEST, '__module__': 'app.datasync.v1.data_sync_pb2'})
_sym_db.RegisterMessage(FileUploadRequest)
FileUploadResponse = _reflection.GeneratedProtocolMessageType('FileUploadResponse', (_message.Message,), {'DESCRIPTOR': _FILEUPLOADRESPONSE, '__module__': 'app.datasync.v1.data_sync_pb2'})
_sym_db.RegisterMessage(FileUploadResponse)
StreamingDataCaptureUploadRequest = _reflection.GeneratedProtocolMessageType('StreamingDataCaptureUploadRequest', (_message.Message,), {'DESCRIPTOR': _STREAMINGDATACAPTUREUPLOADREQUEST, '__module__': 'app.datasync.v1.data_sync_pb2'})
_sym_db.RegisterMessage(StreamingDataCaptureUploadRequest)
StreamingDataCaptureUploadResponse = _reflection.GeneratedProtocolMessageType('StreamingDataCaptureUploadResponse', (_message.Message,), {'DESCRIPTOR': _STREAMINGDATACAPTUREUPLOADRESPONSE, '__module__': 'app.datasync.v1.data_sync_pb2'})
_sym_db.RegisterMessage(StreamingDataCaptureUploadResponse)
SensorMetadata = _reflection.GeneratedProtocolMessageType('SensorMetadata', (_message.Message,), {'DESCRIPTOR': _SENSORMETADATA, '__module__': 'app.datasync.v1.data_sync_pb2'})
_sym_db.RegisterMessage(SensorMetadata)
SensorData = _reflection.GeneratedProtocolMessageType('SensorData', (_message.Message,), {'DESCRIPTOR': _SENSORDATA, '__module__': 'app.datasync.v1.data_sync_pb2'})
_sym_db.RegisterMessage(SensorData)
FileData = _reflection.GeneratedProtocolMessageType('FileData', (_message.Message,), {'DESCRIPTOR': _FILEDATA, '__module__': 'app.datasync.v1.data_sync_pb2'})
_sym_db.RegisterMessage(FileData)
UploadMetadata = _reflection.GeneratedProtocolMessageType('UploadMetadata', (_message.Message,), {'MethodParametersEntry': _reflection.GeneratedProtocolMessageType('MethodParametersEntry', (_message.Message,), {'DESCRIPTOR': _UPLOADMETADATA_METHODPARAMETERSENTRY, '__module__': 'app.datasync.v1.data_sync_pb2'}), 'DESCRIPTOR': _UPLOADMETADATA, '__module__': 'app.datasync.v1.data_sync_pb2'})
_sym_db.RegisterMessage(UploadMetadata)
_sym_db.RegisterMessage(UploadMetadata.MethodParametersEntry)
CaptureInterval = _reflection.GeneratedProtocolMessageType('CaptureInterval', (_message.Message,), {'DESCRIPTOR': _CAPTUREINTERVAL, '__module__': 'app.datasync.v1.data_sync_pb2'})
_sym_db.RegisterMessage(CaptureInterval)
DataCaptureMetadata = _reflection.GeneratedProtocolMessageType('DataCaptureMetadata', (_message.Message,), {'MethodParametersEntry': _reflection.GeneratedProtocolMessageType('MethodParametersEntry', (_message.Message,), {'DESCRIPTOR': _DATACAPTUREMETADATA_METHODPARAMETERSENTRY, '__module__': 'app.datasync.v1.data_sync_pb2'}), 'DESCRIPTOR': _DATACAPTUREMETADATA, '__module__': 'app.datasync.v1.data_sync_pb2'})
_sym_db.RegisterMessage(DataCaptureMetadata)
_sym_db.RegisterMessage(DataCaptureMetadata.MethodParametersEntry)
DataCaptureUploadMetadata = _reflection.GeneratedProtocolMessageType('DataCaptureUploadMetadata', (_message.Message,), {'DESCRIPTOR': _DATACAPTUREUPLOADMETADATA, '__module__': 'app.datasync.v1.data_sync_pb2'})
_sym_db.RegisterMessage(DataCaptureUploadMetadata)
_DATASYNCSERVICE = DESCRIPTOR.services_by_name['DataSyncService']
