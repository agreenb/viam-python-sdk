...
GetPositionRequest = _reflection.GeneratedProtocolMessageType('GetPositionRequest', (_message.Message,), {'DESCRIPTOR': _GETPOSITIONREQUEST, '__module__': 'component.encoder.v1.encoder_pb2'})
_sym_db.RegisterMessage(GetPositionRequest)
GetPositionResponse = _reflection.GeneratedProtocolMessageType('GetPositionResponse', (_message.Message,), {'DESCRIPTOR': _GETPOSITIONRESPONSE, '__module__': 'component.encoder.v1.encoder_pb2'})
_sym_db.RegisterMessage(GetPositionResponse)
ResetPositionRequest = _reflection.GeneratedProtocolMessageType('ResetPositionRequest', (_message.Message,), {'DESCRIPTOR': _RESETPOSITIONREQUEST, '__module__': 'component.encoder.v1.encoder_pb2'})
_sym_db.RegisterMessage(ResetPositionRequest)
ResetPositionResponse = _reflection.GeneratedProtocolMessageType('ResetPositionResponse', (_message.Message,), {'DESCRIPTOR': _RESETPOSITIONRESPONSE, '__module__': 'component.encoder.v1.encoder_pb2'})
_sym_db.RegisterMessage(ResetPositionResponse)
GetPropertiesRequest = _reflection.GeneratedProtocolMessageType('GetPropertiesRequest', (_message.Message,), {'DESCRIPTOR': _GETPROPERTIESREQUEST, '__module__': 'component.encoder.v1.encoder_pb2'})
_sym_db.RegisterMessage(GetPropertiesRequest)
GetPropertiesResponse = _reflection.GeneratedProtocolMessageType('GetPropertiesResponse', (_message.Message,), {'DESCRIPTOR': _GETPROPERTIESRESPONSE, '__module__': 'component.encoder.v1.encoder_pb2'})
_sym_db.RegisterMessage(GetPropertiesResponse)
_ENCODERSERVICE = DESCRIPTOR.services_by_name['EncoderService']
