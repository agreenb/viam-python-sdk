...
_GETDETECTIONSFROMCAMERAREQUEST = DESCRIPTOR.message_types_by_name['GetDetectionsFromCameraRequest']
_GETDETECTIONSFROMCAMERARESPONSE = DESCRIPTOR.message_types_by_name['GetDetectionsFromCameraResponse']
_DETECTION = DESCRIPTOR.message_types_by_name['Detection']
_GETCLASSIFICATIONSREQUEST = DESCRIPTOR.message_types_by_name['GetClassificationsRequest']
_GETCLASSIFICATIONSRESPONSE = DESCRIPTOR.message_types_by_name['GetClassificationsResponse']
_GETCLASSIFICATIONSFROMCAMERAREQUEST = DESCRIPTOR.message_types_by_name['GetClassificationsFromCameraRequest']
_GETCLASSIFICATIONSFROMCAMERARESPONSE = DESCRIPTOR.message_types_by_name['GetClassificationsFromCameraResponse']
...
GetDetectionsRequest = _reflection.GeneratedProtocolMessageType('GetDetectionsRequest', (_message.Message,), {'DESCRIPTOR': _GETDETECTIONSREQUEST, '__module__': 'service.vision.v1.vision_pb2'})
_sym_db.RegisterMessage(GetDetectionsRequest)
GetDetectionsResponse = _reflection.GeneratedProtocolMessageType('GetDetectionsResponse', (_message.Message,), {'DESCRIPTOR': _GETDETECTIONSRESPONSE, '__module__': 'service.vision.v1.vision_pb2'})
_sym_db.RegisterMessage(GetDetectionsResponse)
GetDetectionsFromCameraRequest = _reflection.GeneratedProtocolMessageType('GetDetectionsFromCameraRequest', (_message.Message,), {'DESCRIPTOR': _GETDETECTIONSFROMCAMERAREQUEST, '__module__': 'service.vision.v1.vision_pb2'})
_sym_db.RegisterMessage(GetDetectionsFromCameraRequest)
GetDetectionsFromCameraResponse = _reflection.GeneratedProtocolMessageType('GetDetectionsFromCameraResponse', (_message.Message,), {'DESCRIPTOR': _GETDETECTIONSFROMCAMERARESPONSE, '__module__': 'service.vision.v1.vision_pb2'})
_sym_db.RegisterMessage(GetDetectionsFromCameraResponse)
Detection = _reflection.GeneratedProtocolMessageType('Detection', (_message.Message,), {'DESCRIPTOR': _DETECTION, '__module__': 'service.vision.v1.vision_pb2'})
_sym_db.RegisterMessage(Detection)
GetClassificationsRequest = _reflection.GeneratedProtocolMessageType('GetClassificationsRequest', (_message.Message,), {'DESCRIPTOR': _GETCLASSIFICATIONSREQUEST, '__module__': 'service.vision.v1.vision_pb2'})
_sym_db.RegisterMessage(GetClassificationsRequest)
GetClassificationsResponse = _reflection.GeneratedProtocolMessageType('GetClassificationsResponse', (_message.Message,), {'DESCRIPTOR': _GETCLASSIFICATIONSRESPONSE, '__module__': 'service.vision.v1.vision_pb2'})
_sym_db.RegisterMessage(GetClassificationsResponse)
GetClassificationsFromCameraRequest = _reflection.GeneratedProtocolMessageType('GetClassificationsFromCameraRequest', (_message.Message,), {'DESCRIPTOR': _GETCLASSIFICATIONSFROMCAMERAREQUEST, '__module__': 'service.vision.v1.vision_pb2'})
_sym_db.RegisterMessage(GetClassificationsFromCameraRequest)
GetClassificationsFromCameraResponse = _reflection.GeneratedProtocolMessageType('GetClassificationsFromCameraResponse', (_message.Message,), {'DESCRIPTOR': _GETCLASSIFICATIONSFROMCAMERARESPONSE, '__module__': 'service.vision.v1.vision_pb2'})
_sym_db.RegisterMessage(GetClassificationsFromCameraResponse)
Classification = _reflection.GeneratedProtocolMessageType('Classification', (_message.Message,), {'DESCRIPTOR': _CLASSIFICATION, '__module__': 'service.vision.v1.vision_pb2'})
_sym_db.RegisterMessage(Classification)
GetObjectPointCloudsRequest = _reflection.GeneratedProtocolMessageType('GetObjectPointCloudsRequest', (_message.Message,), {'DESCRIPTOR': _GETOBJECTPOINTCLOUDSREQUEST, '__module__': 'service.vision.v1.vision_pb2'})
_sym_db.RegisterMessage(GetObjectPointCloudsRequest)
GetObjectPointCloudsResponse = _reflection.GeneratedProtocolMessageType('GetObjectPointCloudsResponse', (_message.Message,), {'DESCRIPTOR': _GETOBJECTPOINTCLOUDSRESPONSE, '__module__': 'service.vision.v1.vision_pb2'})
